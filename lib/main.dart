...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget _buildButton() => Row(
        ...
        children: [
          TextButton(onPressed: () => getImage(ImageSource.camera), child: Text('카메라')),
          SizedBox(width: 30,),
          TextButton(onPressed: () => getImage(ImageSource.gallery), child: Text('갤러리'))
        ],
      );
}
...
//             source: source, maxDuration: const Duration(seconds: 2));
